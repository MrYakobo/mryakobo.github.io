...
<body>
    <div class="wrapper">
        ...
        <ul>
        <?php
        $wishes = ["Snygg skjorta","Old Spice","Fred på jorden","Kul tshirt","Nespresso-maskin (ej viktigt att den e ny eller dyr)","Wunderbaum (äpplesmak! Viktigt)","Kalsingar","Jacka? (ej så viktigt, endast förslag)"];
        foreach($wishes as $w){
            ?>
            <li><?= $w ?></li>
        <?php
